...
public class FunctionalLinkedListTest {
	...
	FunctionalLinkedList one = new FunctionalLinkedList();
		...
		public final void test(){
			...
			assertTrue(one.rest().isEmpty());
			assertEquals(one.head().getError(), ErrorMessage.EMPTY_STRUCTURE);
			...
			assertEquals(one.rest().head().getReturnValue(), "dog");
		}
